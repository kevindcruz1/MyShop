  ...
  
{
    ...
    $get_order="select * from customer_orders where customer_id='$get_customer_id'AND order_status='pending'";
    $run_cus_order=mysqli_query($db, $get_order);
    $count_order=mysqli_num_rows($run_cus_order);
    ...
    
{
        echo "<div style='padding:20px'>            
              ...
              <h2>You have ($count_order) Pending Orders</h2>
              <h3>You can see your order <a href='my_account.php?my_orders'>LINK</a><br> Or you can pay offline now<a href='pay_offline.php'>Pay Offline</a></h3>   
               </div>";             
}
